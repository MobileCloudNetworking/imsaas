...
class ImsDnsClient(object):
    ...
    def __create_records_pcscf(self, pcscf_ip):
        logger.debug("Creating records for the pcscf %s with domain_name %s, "
    ...
    def __create_records_icscf(self, icscf_ip):
        logger.debug("Creating records for the icscf %s with domain_name %s, "
    ...
    def __create_records_scscf(self, scscf_ip):
        logger.debug("Creating records for the scscf %s with domain_name %s, "
